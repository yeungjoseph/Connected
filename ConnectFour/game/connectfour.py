...
# This module was written by Alex Thornton
...
def make_move(gamestate: 'GameState', column_num: int):
    '''Added by Joseph Yeung. Drops a piece on the board given a column'''
    if column_num == None:
        raise InvalidMoveError
    return drop(gamestate, column_num - 1)
